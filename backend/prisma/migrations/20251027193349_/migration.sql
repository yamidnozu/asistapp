...
CREATE TABLE "usuario_instituciones" (
    ...
    "rol_en_institucion" VARCHAR(50),
    "activo" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "usuario_instituciones_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "usuario_instituciones" ADD CONSTRAINT "usuario_instituciones_usuario_id_fkey" FOREIGN KEY ("usuario_id") REFERENCES "usuarios"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "usuario_instituciones" ADD CONSTRAINT "usuario_instituciones_institucion_id_fkey" FOREIGN KEY ("institucion_id") REFERENCES "instituciones"("id") ON DELETE CASCADE ON UPDATE CASCADE;
