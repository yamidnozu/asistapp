...
class SuperAdminDashboard extends StatelessWidget {
  ...
  Widget _buildUserInfo(AuthProvider authProvider, TextStyle headlineMedium, Color primary, bool isSmallScreen) {
    ...
    final userName = user?['nombres'] ?? user?['apellidos'] ?? 'Super Admin';
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Como super administrador, tienes control completo sobre todas las instituciones y usuarios del sistema.',
                style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Super Admin - AsistApp'),
