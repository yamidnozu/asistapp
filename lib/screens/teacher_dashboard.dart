...
class TeacherDashboard extends StatelessWidget {
  ...
  Widget _buildUserAndInstitutionInfo(AuthProvider authProvider, TextStyle headlineMedium, Color primary, bool isSmallScreen) {
    ...
    final userName = user?['nombres'] ?? user?['apellidos'] ?? 'Profesor';
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Rol: ${selectedInstitution.role ?? 'Profesor'}',
                  style: TextStyle(
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 4),
              Text(
                'Accede a todas las herramientas necesarias para gestionar tus clases y el seguimiento de tus estudiantes.',
                style: TextStyle(
