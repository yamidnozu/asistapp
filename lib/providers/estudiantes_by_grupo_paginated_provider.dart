...
class EstudiantesByGrupoPaginatedProvider extends ChangeNotifier
  ...
  Future<void> loadEstudiantes(String accessToken, String grupoId,
      {int page = 1, int? limit}) async {
    setFilter('grupoId', grupoId);
    await loadItems(accessToken,
        page: page, limit: limit, filters: {'grupoId': grupoId});
  }
